...
let storyText = '今天气温 34摄氏度，:inserta:出去遛弯。当走到:insertb:门前时，突然就:insertc:。人们都惊呆了，李雷全程目睹但并没有慌，因为:inserta:是一个 130公斤的胖子，天气又辣么热。';
...
function result(){
    ...
    if(document.getElementById('american').checked){
      ...
      newStory = newStory.replace('34摄氏度',temperature);
    }
